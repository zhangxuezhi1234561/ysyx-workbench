...
void Vcore_core___configure_coverage(Vcore_core* vlSelf, bool first);

void Vcore_core::__Vconfigure(bool first) {
    if (false && first) {}  // Prevent unused
    Vcore_core___configure_coverage(this, first);
}
...
// Coverage
void Vcore_core::__vlCoverInsert(std::atomic<uint32_t>* countp, bool enable, const char* filenamep, int lineno, int column,
