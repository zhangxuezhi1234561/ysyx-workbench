...
void Vcore___024root___configure_coverage(Vcore___024root* vlSelf, bool first);

void Vcore___024root::__Vconfigure(bool first) {
    if (false && first) {}  // Prevent unused
    Vcore___024root___configure_coverage(this, first);
}
...
// Coverage
void Vcore___024root::__vlCoverInsert(std::atomic<uint32_t>* countp, bool enable, const char* filenamep, int lineno, int column,
